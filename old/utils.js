// Deprecated copy of utils.js moved to old/ for backup
// Original utilities (storage + scoring) — kept as backup in old/
// If you need to restore, move this file back to `js/`.
